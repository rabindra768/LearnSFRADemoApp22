...
var CategorySuggestions = proxyquire('app_capri_core/cartridge/models/search/suggestions/category.js', {
    'dw/web/URLUtils': {
        url: urlStub
    }
});
describe('Category Suggestions model', function () {
    ...
    it('should return categorySuggestions.available as false', function () {
        var suggestions = {
            categorySuggestions: false
        };
        var categorySuggestions = new CategorySuggestions(suggestions, 3);
        assert.isFalse(categorySuggestions.available);
    });
});
